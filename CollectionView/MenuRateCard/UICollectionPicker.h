...
extern const CGFloat kUICollectionPickerHeight;

@interface UICollectionPicker : UIControl <UICollectionViewDataSource, UICollectionViewDelegate,UICollectionViewDelegateFlowLayout>
