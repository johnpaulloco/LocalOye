...
const CGFloat kDIDatepickerSpaceBetweenItemsForThreeItems = 35.;
const CGFloat kDIDatepickerSpaceBetweenItemsForTwoItems = 55.;
const CGFloat kDIDatepickerSpaceBetweenItemsForOneItems = 85.;
...
- (UICollectionView *)datesCollectionView
{
    if (!_datesCollectionView) {
        ...
        //else
        //    [collectionViewLayout setItemSize:CGSizeMake(90., CGRectGetHeight(self.bounds))];
        
        [collectionViewLayout setScrollDirection:UICollectionViewScrollDirectionHorizontal];
        _datesCollectionView.backgroundColor = [UIColor redColor];
       ...
       [collectionViewLayout setMinimumLineSpacing:kDIDatepickerSpaceBetweenItems];
        ...
        //[_datesCollectionView setBackgroundColor:[[UIColor alloc] initWithPatternImage:[UIImage imageNamed:@"TabBarBG"]]];
        //_datesCollectionView.backgroundColor =[UIColor colorWithRed:236.0f/255.0f  green:236.0f/255.0f blue:236.0f/255.0f alpha:1];
...
//    return UIEdgeInsetsMake(160, 190, 590, 190);
//}
...
//        //[dates addObject:@"health And Fitness"];
//    }
    
    for (id data in SHARED_DELEGATE.majorCategoryList)
    {
