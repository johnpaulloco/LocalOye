...
- (void)setDate:(NSDate *)date
{
    ...
    [self.dateLabel setFont:[UIFont fontWithName:@"HelveticaNeue-Thin" size:10]];
    
    //self.dateLabel.attributedText = dateString;
    NSMutableAttributedString *dateString1 = [[NSMutableAttributedString alloc] initWithString:@"health and fitness"];
    self.dateLabel.attributedText = dateString1;
}
